export default async function handler(req, res) {
  try {
    // Default limit = 100 (your paid plan allows this)
    ...
    if (!apiKey) {
      return res.status(500).json({ error: "b2eb114113547c1eeb296f358fb10653acc0727a" });
    }

    // Build Hunter.io URL with limit=100 and offset for pagination
